...
//db configue 
const PORT = process.env.PORT || 5000;  //checks process if any port availablein (.env)  or use 3000
...
app.set('layout',path.join(__dirname,'/resources/views/layout/userLayout'));   //sets layout path for express in folder
